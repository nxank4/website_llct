    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Giảng viên & Trợ giảng</h1>
              <p className="text-gray-600 dark:text-gray-400 mt-1">Thông tin và liên hệ với đội ngũ giảng dạy</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-6">
                {instructors.map((instructor) => (
                  <div key={instructor.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="ml-1 text-sm font-medium text-gray-900 dark:text-white">{instructor.rating}</span>
                          </div>
                        </div>
                        
                        <p className="text-gray-600 dark:text-gray-400 mb-2">{instructor.title} - {instructor.subject}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-500 mb-4">{instructor.bio}</p>
            ...
            <div className="lg:col-span-1">
              {selectedInstructor ? (
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sticky top-8">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Thông tin chi tiết</h2>
                  
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-white mb-2">Liên hệ</h3>
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-white mb-2">Giờ làm việc</h3>
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-white mb-2">Học vấn</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{selectedInstructor.education}</p>
                    </div>
                    
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-white mb-2">Chuyên môn</h3>
                      <div className="space-y-1">
                        {selectedInstructor.specialties.map((specialty, index) => (
                          <div key={index} className="text-sm text-gray-600 dark:text-gray-400">• {specialty}</div>
                        ))}
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Chọn giảng viên</h3>
                    <p className="text-gray-500 dark:text-gray-400">Nhấn "Chi tiết" để xem thông tin đầy đủ</p>
                  </div>
                </div>
              )}
            </div>
        ...
        {activeTab === 'assistants' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {teachingAssistants.map((ta) => (
              <div key={ta.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="w-16 h-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center">
                    <User className="h-8 w-8 text-gray-400 dark:text-gray-500" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{ta.name}</h3>
                    <p className="text-gray-600 dark:text-gray-400">{ta.subject} - {ta.year}</p>
                ...
                <div className="mb-4">
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">Chuyên môn hỗ trợ</h4>
        ...
        {activeTab === 'articles' && (
          <div className="space-y-6">
            {recentArticles.map((article) => (
              <div key={article.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        {activeTab === 'feedback' && (
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Hệ thống phản hồi & đánh giá chéo</h2>
                ...
                <div key={feedback.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex space-x-2">
                      <button className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">Thích</button>
                      <button className="text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Phản hồi</button>
                    </div>
                  </div>
                </div>
              ))}
