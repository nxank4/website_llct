...
import { Users, UserPlus, Shield, Eye, Edit, Trash2, Search, Filter, BarChart3, Brain, BookOpen, FileText, MessageSquare } from 'lucide-react';
...
export default function MembersPage() {
  ...
  const sidebarItems = [
    ...
    { id: 'members', title: 'Thành viên', icon: Users, color: '#8B5CF6', href: '/admin/members', active: true }
  ];
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  {isAdmin ? 'Quản lý người dùng và phân quyền hệ thống' : 'Xem danh sách thành viên hệ thống'}
                </p>
              </div>
              {isAdmin && (
                <button
                    ...
                    <tr key={user.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div>
                          ...
                          {user.last_login && (
                            <div>Truy cập: {new Date(user.last_login).toLocaleDateString('vi-VN')}</div>
                          )}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        {isAdmin ? (
                          ...
                          <span className="text-gray-400 text-sm">Chỉ xem</span>
                        )}
                      </td>
                    </tr>
                  ))}
