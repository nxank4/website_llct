...
export default function AdminLecturesPage() {
  const { user } = useAuth();
  const [activeSidebarItem, setActiveSidebarItem] = useState('lectures');

  const sidebarItems = [
    { id: 'dashboard', label: 'Bảng tổng kết', icon: BarChart3, href: '/admin/dashboard' },
    { id: 'ai-data', label: 'Dữ liệu AI', icon: Brain, href: '/admin/ai-data' },
    { id: 'library', label: 'Thư viện môn học', icon: BookOpen, href: '/admin/library' },
    { id: 'products', label: 'Sản phẩm học tập', icon: FileText, href: '/admin/products' },
    { id: 'tests', label: 'Bài kiểm tra', icon: FileText, href: '/admin/tests' },
        ...
        <div className="w-56 bg-blue-600 text-white">
          <div className="p-4 md:p-6">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <div>
                <div className="text-base md:text-lg font-semibold">Soft Skills</div>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="bg-white shadow-sm border-b border-gray-200 px-4 md:px-6 py-3 md:py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-lg md:text-xl font-semibold text-gray-900">Soft Skills Department</h1>
                  <p className="text-xs md:text-sm text-gray-600">Trường ĐH FPT</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  <div className="flex items-center space-x-2">
                    <span className="text-gray-900 font-medium text-sm md:text-base">Chào mừng, Nguyễn Văn Bình</span>
          ...
          <main className="flex-1 p-4 md:p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Bài giảng</h2>
                ...
                <div key={section.code} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  {section.items.length > 0 ? (
                    <>
                            ...
                            <div className="mb-4">
                              <div className="w-full h-28 md:h-32 bg-gray-100 rounded-lg flex items-center justify-center mb-4">
                                <div className="text-center">
                                  ...
                                  <p className="text-xs text-gray-500">Video call with coffee</p>
                                </div>
                              </div>
                              <h4 className="font-semibold text-gray-900 mb-2 text-sm md:text-base">{item.title}</h4>
                              <p className="text-xs md:text-sm text-gray-600 mb-1">{item.instructor}</p>
                              <p className="text-xs md:text-sm text-gray-600 mb-1">{item.date}</p>
                      ...
                      <div className="flex justify-center mt-4 md:mt-6">
                        <div className="flex items-center space-x-2">
                          ...
                          <button className="px-2 py-1 bg-blue-600 text-white rounded text-sm">1</button>
                          <button className="px-2 py-1 text-gray-500 hover:text-gray-700 text-sm">2</button>
                          <button className="px-2 py-1 text-gray-500 hover:text-gray-700 text-sm">3</button>
                          <button className="px-2 py-1 text-gray-500 hover:text-gray-700 text-sm">›</button>
                        </div>
                      </div>
                    </>
                    ...
                    <div className="text-center py-10 md:py-12">
                      ...
                      <h4 className="text-base md:text-lg font-semibold text-gray-900 mb-2">Chưa có tài liệu</h4>
                      <p className="text-sm md:text-base text-gray-600 mb-6">Hãy tải lên nội dung đầu tiên cho khóa học này</p>
          ...
          <footer className="bg-blue-800 text-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div className="text-white">
                      <div className="text-base md:text-lg font-semibold">Soft Skills Department</div>
                      <div className="text-xs md:text-sm opacity-90">Trường ĐH FPT</div>
                    </div>
                  </div>
                </div>
                ...
                {/* Right Column */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold mb-4">Thầy Văn Bình</h3>
                  <div className="space-y-2 text-xs md:text-sm">
                    <div>Chức vụ:</div>
                    <div>Email: vanbinh@fpt.edu.vn</div>
                    <div>Zalo: 090.xxx.xxx</div>
