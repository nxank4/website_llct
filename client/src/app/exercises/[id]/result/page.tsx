  ...
  useEffect(() => {
    ...
    if (score && correctAnswers && totalQuestions) {
      ...
      setResultData({
        ...
        timeTaken: timeTaken ? formatTime(parseInt(timeTaken)) : '00:00:00',
      ...
      if (latestResult) {
        ...
        setResultData({
          ...
          timeTaken: formatTime(latestResult.time_taken),
          date: new Date(latestResult.completed_at).toLocaleDateString('vi-VN'),
              ...
              <div className="bg-gray-50 rounded-lg p-8 shadow-sm border border-gray-200">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <span className={`px-4 py-2 rounded-full text-sm font-medium ${
                    ...
                    {resultData.score >= 80 ? 'Xuất sắc' : resultData.score >= 60 ? 'Đạt' : 'Chưa đạt'}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-gray-900">{resultData.timeTaken}</span>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 font-medium">Ngày làm bài:</span>
                      <span className="text-lg font-bold text-gray-900">{resultData.date}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 font-medium">Tỷ lệ đúng:</span>
                      <span className="text-lg font-bold text-gray-900">
